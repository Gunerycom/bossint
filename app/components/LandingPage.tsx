...
export default function LandingPage({ onLogin }: LandingPageProps) {
  ...
  const handleEmailSubmit = (e: React.FormEvent) => {
    ...
    // For demo/presentation purposes, we accept the specified email to proceed to password
    if (email.trim().toLowerCase() === "gokhan@gunery.com") {
      setStep("password");
    } else {
      setError("Demo Email not found. Use gokhan@gunery.com");
    }
  };
  ...
  const handleModalAuthSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setModalError("");
              ...
              {step === "email" ? (
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="Enter your email (e.g. gokhan@gunery.com)"
                ...
                <form onSubmit={handlePasswordSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="text-xs font-semibold text-neutral-500 hover:text-neutral-900 flex items-center gap-1 mb-2 cursor-pointer"
                  >
                    ← Back to Email
                  </button>

                  {/* User email info badge */}
                  <div className="bg-neutral-50 border border-neutral-100 p-2.5 rounded-xl text-xs text-neutral-600 flex items-center justify-between">
                    <span>Signing in as: <b>{email}</b></span>
                  </div>
